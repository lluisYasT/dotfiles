...
myLogHook h = dynamicLogWithPP ( defaultPP
	{
		...
		, ppLayout		= wrap "^ca(1,xdotool key alt+space)" "^ca()" . dzenColor color2 background .
				(\x -> case x of
					"Full"				->	"^i(/home/lluis/.xmonad/dzen2/layout_full.xbm)"
					"Spacing 5 ResizableTall"	->	"^i(/home/lluis/.xmonad/dzen2/layout_tall.xbm)"
					"ResizableTall"			->	"^i(/home/lluis/.xmonad/dzen2/layout_tall.xbm)"
					"SimplestFloat"			->	"^i(/home/lluis/.xmonad/dzen2/mouse_01.xbm)"
					"Circle"			->	"^i(/home/lluis/.xmonad/dzen2/full.xbm)"
					_				->	"^i(/home/lluis/.xmonad/dzen2/grid.xbm)"
				) 
...
myStatusBar = "/home/lluis/.xmonad/status_bar '"++foreground++"' '"++background++"' "++myFont
--myConky = "conky -c /home/lluis/conkyrc"
--myStartMenu = "/home/lluis/.xmonad/start /home/lluis/.xmonad/start_apps"


main = do
	dzenLeftBar 	<- spawnPipe myXmonadBar
	dzenRightBar	<- spawnPipe myStatusBar
--	xmproc 		<- spawnPipe "GTK2_RC_FILES=/home/lluis/.gtkdocky /usr/bin/docky"
--	xmproc 		<- spawnPipe "tint2 -c /home/lluis/.config/tint2/xmonad.tint2rc"
--	conky 		<- spawn myConky
...
--------------------------------------------------------------------------------------------------------------------
		...
		,((mod1Mask 			, xK_r), spawn "/home/lluis/scripts/lens")
		,((mod1Mask .|. shiftMask	, xK_r), spawn "/home/lluis/scripts/dmenu/spotlight")
		...
		,((0                     	, xF86XK_AudioLowerVolume), spawn "/home/lluis/scripts/dvol2 -d 2 & mplayer /usr/share/sounds/freedesktop/stereo/audio-volume-change.oga")
		,((0                     	, xF86XK_AudioRaiseVolume), spawn "/home/lluis/scripts/dvol2 -i 2 & mplayer /usr/share/sounds/freedesktop/stereo/audio-volume-change.oga")
		,((0                     	, xF86XK_AudioMute), spawn "/home/lluis/scripts/dvol2 -t")
		,((0                     	, xF86XK_Display), spawn "/home/lluis/scripts/project")
